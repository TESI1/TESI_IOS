...
- (void)viewDidLoad
{
    ...
    SoundDetailView = [[UIImageView alloc]initWithFrame:CGRectMake(80, 100, 150, 150)];
    [SoundDetailView setImage:SoundDetail];
    SoundDetailView.contentMode = UIViewContentModeScaleAspectFill;
    [self.view addSubview:SoundDetailView];
}
